...
const ScoreCounter = ({
  ...
  return (
    <div className={`text-white rounded-lg p-4 ${bgColor} mt-5`}>
      <h1 className="text-2xl font-bold mb-4">PUNTOS {colorTraducido.toUpperCase()}</h1>
      <div className="text-2xl font-bold mb-4">{score}</div>
      <h1 className="text-2xl font-bold mb-4">FALTAS {colorTraducido.toUpperCase()}</h1>
      <div className="text-2xl font-bold mb-4">{faults}</div>
